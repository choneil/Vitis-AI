...
/**
 *@struct YOLOv4Result
 *@brief Struct of the result returned by the YOLOv4 neural network.
...
/**
 *@brief Post-process of the YOLOv4 neural network.
...
/**
 *@brief Post-process of the YOLOv4 neural network in batch mode.
 *@param input_tensors A vector of all input-tensors in the network.
 * Usage: input_tensors[input_tensor_index].
 *@param output_tensors A vector of all output-tensors in the network.
 *Usage: output_tensors[output_index].
 ...
 *@return The vector of struct of YOLOv4Result.
 */
