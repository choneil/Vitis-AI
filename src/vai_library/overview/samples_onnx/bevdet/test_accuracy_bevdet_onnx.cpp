...
void accuracy_thread(BEVDetPtOnnx* det, int i, int t_n, std::string f_name) {
...
int main(int argc, char* argv[]) {
  ...
  std::vector<std::unique_ptr<BEVDetPtOnnx>> vdet;
  std::vector<std::string> out_fname_t(t_n);
  for (int i = 0; i < t_n; i++) {
    vdet.emplace_back(BEVDetPtOnnx::create(argv[1]));
