 ...
 * @code
    auto yolo =
 vitis::ai::YOLOv5::create("yolov5", true);
    Mat img = cv::imread("sample_yolov5.jpg");
    ...
    imwrite("sample_yolov5_result.jpg", img);
   @endcode
 *
 * Display of the model results:
 * @image latex images/sample_yolov5_result.jpg "out image" width=\textwidth
 */
class YOLOv5 : public ConfigurableDpuTaskBase {
 public:
  /**
   ...
   *value is true.
   *
   * @return An instance of YOLOv5 class.
   *
   */
  static std::unique_ptr<YOLOv5> create(const std::string& model_name,
                                        bool need_preprocess = true);
  /**
   * @cond NOCOMMENTS
   */
 protected:
  explicit YOLOv5(const std::string& model_name, bool need_preprocess);
 ...
 public:
  /**
   * @brief Function to get running result of the YOLOv5 neural network.
   *
   ...
   *
   */
  virtual YOLOv5Result run(const cv::Mat& image) = 0;
  /**
   * @brief Function to get running result of the YOLOv5 neural network
   * in batch mode.
   *
   ...
   *
   * @return The vector of YOLOv5Result.
   *
   */
  virtual std::vector<YOLOv5Result> run(const std::vector<cv::Mat>& images) = 0;
  /**
   * @brief Function to get running result of the YOLOv5 neural network
